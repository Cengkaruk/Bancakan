...
<div class="row single-question">
  ...
  <div class="column">
    <h4>What are different options for raising funds to buy an established online business?</h4>
    <div class="row">
      ...
      <div class="column column-34">
        <p>
          ...
          <small>12 answers - 13 hours ago</small><br>
          <a href="#">
            <strong>Aji Kisworo Mukti</strong>
          </a>
          <br>
          <small><a href="#">Share</a> - <a href="#">Report</a></small>
        </p>
      </div>
    </div>
  </div>
